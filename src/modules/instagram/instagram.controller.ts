...
export class InstagramAccountController {
  ...
  async putAutomation(
    ...
    try {
      ...
      return await this.instagramAccountService.addInstagramMediaAutomation(
        mediaId,
        input,
      );
    } catch (error) {
  ...
  async updateAccountMedia(@Param('accountId') accountId: string) {
    try {
      return await this.instagramAccountService.updateAccountMediaOnTable(
        accountId,
      );
    } catch (error) {
      console.log(
  ...
  async getTagAndValueFromTable(@Param('mediaId') mediaId: string) {
    try {
      return await this.instagramAccountService.getTagAndValuePairFromTable(
        mediaId,
      );
    } catch (error) {
      console.log(
  ...
  async updateMediaResponseType(
    ...
    try {
      return await this.instagramAccountService.updateMediaResponseTypeOnTable(
        mediaId,
        input,
      );
    } catch (error) {
  ...
  async getMediaResponseType(@Param('mediaId') mediaId: string) {
    try {
      return await this.instagramAccountService.getMediaResponseTypeFromTable(
        mediaId,
      );
    } catch (error) {
  ...
  @InstagramResourceType("account")
  @Post(':accountId/media/search')
  async searchMedia(@Param('accountId') accountId: string, @Body() input: { permalink: string}) {
    console.log("searching media!!!!!")
    return this.instagramAccountService.getOrFetchMedia(input['permalink'], accountId);
  }
  ...
  async getAIEnabledFromTable(@Param('mediaId') mediaId: string) {
    try {
      return await this.instagramAccountService.getAIEnabledInfoFromTable(
        mediaId,
      );
    } catch (error) {
      console.log(
  ...
  async getMediaStats(@Param('mediaId') mediaId: string) {
    try {
      ...
      console.log(
        `Failed to get the numerical stats (positive comments, leads, etc.) for ${mediaId}:`,
        (error as Error).message,
      );
      throw new Error(
        `Failed to get the numerical stats (positive comments, leads, etc.) for ${mediaId}`,
  ...
  async getMediaComments(
    ...
    try {
      ...
      const comments =
        await this.instagramAccountService.getCommentsFromAnalyticsTable(
          mediaId,
          `${type}`,
        );
      return comments;
      ...
      console.log(
        `Failed to fetch ${type} comments for ${mediaId}:`,
        (error as Error).message,
      );
  ...
  async getCommentTimeSeries(@Param('mediaId') mediaId: string) {
    try {
      const result =
        await this.instagramAccountService.getCommentTimeSeriesByIntervals(
          mediaId,
        );
      return result;
    } catch (error) {
      console.error(
        `Error fetching time series for  comments on media ${mediaId}:`,
        error,
      );
  ...
  async deleteAccount(@Param('accountId') accountId: string) {
    try {
      ...
      return await this.instagramAccountService.deleteInstagramAccount(
        accountId,
      );
    } catch (error) {
      console.log(
        `Failed to delete the account ${accountId}:`,
        (error as Error).message,
      );
  ...
  async updateAccountStory(@Param('accountId') accountId: string) {
    try {
      return await this.instagramAccountService.updateAccountStoryOnTable(
        accountId,
      );
    } catch (error) {
      console.log(
        'Failed to update the story-table with recent media:',
        (error as Error).message,
      );
  ...
  async getStoryDetails(@Param('storyId') mediaId: string) {
    try {
      return await this.instagramAccountService.getStoryDetailsFromTable(
        mediaId,
      );
    } catch (error) {
  ...
  async putStoryAutomation(
    ...
    try {
      ...
      // Pass the JSON string to the service method
      return await this.instagramAccountService.addInstagramStoryAutomation(
        storyId,
        input,
      );
    } catch (error) {
  ...
  async getDMCategorization(@Param('accountId') accountId: string) {
    try {
      ...
      console.log(
        'Failed to get DM categorization :',
        (error as Error).message,
      );
  ...
  async getDMConversation(@Param('conversationId') conversationId: string) {
    try {
      return await this.instagramAccountService.getDMConversation(
        conversationId,
      );
    } catch (error) {
  ...
  async updateDMCategory(
    ...
    try {
      return await this.instagramAccountService.updateDMCategory(
        conversationId,
        input,
      );
    } catch (error) {
  ...
  async getAds(@Param('accountId') accountId: string) {
    try {
      ...
      throw new Error(
        'Failed to get the ads for the account from the instagram_ads_repository table',
      );
    }
  }
  ...
  async isFacebookLinked(@Param('accountId') accountId: string) {
    try {
      ...
      console.log(
        'Failed to fetch the wether the Facebook account being added or not!',
      );
      throw new Error(
        'Failed to fetch the wether the Facebook account being added or not!',
      );
  ...
  async putAutomationAd(
    ...
    try {
      // Pass the JSON string to the service method
      return await this.instagramAccountService.addInstagramAdAutomation(
        mediaId,
        input,
      );
    } catch (error) {
  ...
  async getAdStats(@Param('adId') adId: string) {
    try {
      ...
      console.log(
        `Failed to get the analytics stats for ${adId}:`,
        (error as Error).message,
      );
  ...
  async getAdComments(
    ...
    try {
      const comments =
        await this.instagramAccountService.getCommentsFromAdAnalyticsTable(
          adId,
          `${type}`,
        );
      return comments;
      ...
      console.log(
        `Failed to fetch ${type} comments for ad ${adId}:`,
        (error as Error).message,
      );
  ...
  async getAccountLevelAnalytics(@Param('accountId') accountId: string) {
    try {
      return await this.instagramAccountService.getAccountLevelAnalytics(
        accountId,
      );
    } catch (error) {
      console.log(
        `Failed to get account level analytics for ${accountId}:`,
        (error as Error).message,
      );
  ...
  async getDMSummaryAnalytics(@Param('accountId') accountId: string) {
    try {
      return await this.instagramAccountService.getDMSummaryAnalytics(
        accountId,
      );
    } catch (error) {
      console.log(
        `Failed to get DM summary analytics for ${accountId}:`,
        (error as Error).message,
      );
  ...
  async getDMConversations(@Param('accountId') accountId: string) {
    try {
      ...
      console.log(
        `Failed to get DM conversations for ${accountId}:`,
        (error as Error).message,
      );
  ...
  async getDMConversationDetails(
    @Param('accountId') accountId: string,
    @Param('conversationId') conversationId: string,
  ) {
    try {
      return await this.instagramAccountService.getDMConversationDetails(
        accountId,
        conversationId,
      );
    } catch (error) {
      console.log(
        `Failed to get DM conversation details for ${conversationId} in account ${accountId}:`,
        (error as Error).message,
      );
      throw new Error(
        `Failed to get DM conversation details for ${conversationId} in account ${accountId}`,
  ...
  async getMediaAnalytics(@Param('accountId') accountId: string) {
    try {
      ...
      console.log(
        `Failed to get media analytics for ${accountId}:`,
        (error as Error).message,
      );
  ...
  async getMediaAnalyticsById(
    @Param('accountId') accountId: string,
    @Param('mediaId') mediaId: string,
  ) {
    try {
      return await this.instagramAccountService.getMediaAnalyticsById(
        accountId,
        mediaId,
      );
    } catch (error) {
      console.log(
        `Failed to get media analytics for ${mediaId} in account ${accountId}:`,
        (error as Error).message,
      );
      throw new Error(
        `Failed to get media analytics for ${mediaId} in account ${accountId}`,
  ...
  async getMediaCommentsByCategory(
    ...
    try {
      ...
      return await this.instagramAccountService.getMediaCommentsByCategory(
        accountId,
        mediaId,
        category,
      );
      ...
      console.log(
        `Failed to get """${category}""" comments for media ${mediaId} in account ${accountId}:`,
        (error as Error).message,
      );
      throw new Error(
        `Failed to get ${category} comments for media ${mediaId} in account ${accountId}`,
  ...
  async getMediaCommentCounts(@Param('accountId') accountId: string) {
    try {
      ...
      return await this.instagramAccountService.getMediaCommentCounts(
        accountId,
      );
    } catch (error) {
      console.log(
        `Failed to get comment counts for media in account ${accountId}:`,
        (error as Error).message,
      );
      throw new Error(
        `Failed to get comment counts for media in account ${accountId}`,
  ...
  async getAdsAnalytics(@Param('accountId') accountId: string) {
    try {
      ...
      console.log(
        `Failed to get ads analytics for ${accountId}:`,
        (error as Error).message,
      );
  ...
  async getAdsAnalyticsById(
    @Param('accountId') accountId: string,
    @Param('adId') adId: string,
  ) {
    try {
      return await this.instagramAccountService.getAdAnalyticsById(
        accountId,
        adId,
      );
    } catch (error) {
      console.log(
        `Failed to get media analytics for ${adId} in account ${accountId}:`,
        (error as Error).message,
      );
      throw new Error(
        `Failed to get media analytics for ${adId} in account ${accountId}`,
  ...
  async getAdCommentCounts(@Param('accountId') accountId: string) {
    try {
      ...
      console.log(
        `Failed to get comment counts for ads in account ${accountId}:`,
        (error as Error).message,
      );
      throw new Error(
        `Failed to get comment counts for ads in account ${accountId}`,
  ...
  async getQuickReplies(@Param('accountId') accountId: string) {
    try {
      ...
      console.log(
        `Failed to get quick replies for ${accountId}:`,
        (error as Error).message,
      );
  ...
  async createQuickReply(
    @Param('accountId') accountId: string,
    @Body() input: Array<{ category: string; title: string; content: string }>,
  ) {
    try {
      return await this.instagramAccountService.createQuickReply(
        accountId,
        input,
      );
    } catch (error) {
      console.log(
        `Failed to create quick reply for ${accountId}:`,
        (error as Error).message,
      );
  ...
  async updateQuickReply(
    ...
    try {
      return await this.instagramAccountService.updateQuickReply(
        accountId,
        quickReplyId,
        input,
      );
      ...
      console.log(
        `Failed to update quick reply ${quickReplyId} for ${accountId}:`,
        (error as Error).message,
      );
      throw new Error(
        `Failed to update quick reply ${quickReplyId} for ${accountId}`,
  ...
  async deleteQuickReply(
    ...
    try {
      return await this.instagramAccountService.deleteQuickReply(
        accountId,
        quickReplyId,
      );
    } catch (error) {
      console.log(
        `Failed to delete quick reply ${quickReplyId} for ${accountId}:`,
        (error as Error).message,
      );
      throw new Error(
        `Failed to delete quick reply ${quickReplyId} for ${accountId}`,
  ...
  async putFlowstate(
    ...
    try {
      return await this.instagramAccountService.addInstagramDMFlowstate(
        accountId,
        input,
      );
    } catch (error) {
      console.log(
        'Failed to update the table with DM flowstate:',
        (error as Error).message,
      );
  ...
  @InstagramResourceType('account')
  @Get(':accountId/flowstate/:flowstateId')
  async getFlowState(
    @Param('accountId') accountId: string,
    @Param('flowstateId') flowstateId: string,
  ) {
    try {
      return await this.instagramAccountService.getInstagramDMFlowstateDetails(
        flowstateId,
      );
    } catch (error) {
      console.log('Failed to get the DM flowstate:', (error as Error).message);
